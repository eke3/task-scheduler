...
struct task_struct* producer_threads[3];
...
int KTHREAD_schedule_tasks(void* arg) {
...
void run_schedule_tasks() {
   ...
   producer_threads[0] = kthread_run(KTHREAD_schedule_tasks, NULL, "schedule_tasks");
   producer_threads[1] = kthread_run(KTHREAD_schedule_tasks, NULL, "schedule_tasks");
   producer_threads[2] = kthread_run(KTHREAD_schedule_tasks, NULL, "schedule_tasks");


   kthread_stop(producer_threads[0]);
   kthread_stop(producer_threads[1]);
   kthread_stop(producer_threads[2]);
}
