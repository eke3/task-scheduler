...
asmlinkage long sys_print_pq(void);

asmlinkage long sys_print_rq(void);

asmlinkage long sys_print_wq(void);
...
asmlinkage long sys_add_resource(int rid, int quantity);
#endif
